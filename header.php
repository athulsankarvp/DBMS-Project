...
<nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="background-color: #000000;">
  <a class="navbar-brand text-center mr-auto" style="font-family: 'Jost', sans-serif;" href="#"><img width="40" height="40" src="images/icons/logo.svg" alt="logo">ABC Cinemas</a>
